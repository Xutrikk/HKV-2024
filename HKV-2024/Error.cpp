...
namespace Error
{
	...
	{
		ERROR_ENTRY(0, "[ERROR]# Недопустимый код ошибки"), //код ошибки вне диапазона 0-ERROR_MAX_ENTRY
		...
		ERROR_ENTRY(162,"[LEX] превышен максимальный пазмер имени идентификатора"),
		ERROR_ENTRY(163,"[LEX]# Не удалось распознать цепочку"),
		ERROR_ENTRY(164,"[LEX]# Размер литерала больше максимально допустимого"),
		ERROR_ENTRY(165,"[SEM]# Отсутствует точка входа main"),
		ERROR_ENTRY_NODEF(166),
		ERROR_ENTRY_NODEF(167), ERROR_ENTRY_NODEF(168),
		ERROR_ENTRY(169,"[LEX]# Превышено количество параметров функции"),
		...
		ERROR_ENTRY(320,"[SEM] рекурсия недопутима"),ERROR_ENTRY_NODEF10(330),
		ERROR_ENTRY(331,"[PolNot]# Превышено максимальное кол-во параметров"),
